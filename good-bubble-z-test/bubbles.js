...
const bokehPass = new BokehPass(scene, camera, {
  focus: 30.0, // 焦点距离（相机到焦平面的距离）
  aperture: 0.00005, // 光圈大小（越大模糊越强）
  maxblur: 0.01, // 最大模糊强度
  width: sizes.width,
  height: sizes.height,
});
...
document.getElementById("resetDOF").addEventListener("click", () => {
  bokehPass.uniforms.focus.value = 30.0;
  bokehPass.uniforms.aperture.value = 0.00005;
  bokehPass.uniforms.maxblur.value = 0.01;
  document.getElementById("focus").value = 30;
  document.getElementById("aperture").value = 0.00005;
  document.getElementById("maxBlur").value = 0.01;
  document.getElementById("focusValue").textContent = "30.0";
  document.getElementById("apertureValue").textContent = "0.00005";
